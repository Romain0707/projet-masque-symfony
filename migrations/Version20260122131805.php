 ...
 */
final class Version20260122131805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE masque CHANGE description description LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE masque CHANGE description description VARCHAR(255) DEFAULT NULL');
