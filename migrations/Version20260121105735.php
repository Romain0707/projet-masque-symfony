 ...
 */
final class Version20260121105735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE masque ADD user_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE masque ADD CONSTRAINT FK_E2D3F6ABA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_E2D3F6ABA76ED395 ON masque (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E2D3F6ABA76ED395 ON masque');
        $this->addSql('ALTER TABLE masque DROP user_id');
